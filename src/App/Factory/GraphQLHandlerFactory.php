...
use App\Resolver\DeleteTapeUserHistoryResolver;
...
use App\Resolver\ListTvShowChapterResolver;
    ...
    protected static function getQueryType(ResolverManager $manager): ObjectType
    {
        return new ObjectType([
            'fields' => [
                ...
                'listTvShowChapter' => $manager->get(ListTvShowChapterResolver::class),
    ...
    protected static function getMutationType(ResolverManager $manager): ObjectType
    {
        return new ObjectType([
            'fields' => [
                ...
                'deleteTapeUserHistory' => $manager->get(DeleteTapeUserHistoryResolver::class)
            ],
            'name' => 'mutation'
        ]);
    }
