...
class TapeUserHistory implements CinemaEntity
{
     ...
     * @var TapeUser
     *
     * @ORM\ManyToOne(targetEntity="TapeUser", fetch="EXTRA_LAZY", orphanRemoval=false)
     ...
     * @var TapeUserStatus
     *
     * @ORM\ManyToOne(targetEntity="TapeUserStatus", fetch="EXTRA_LAZY", orphanRemoval=false)
